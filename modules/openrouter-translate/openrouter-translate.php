...
class DPT_OpenRouter_Translate_Provider implements DPT_Translation_Provider_Interface {
    ...
    public function test_connection() {
        ...
        try {
            // Test semplificato: verifica solo la validità dell'API key
            ...
            return new WP_Error('test_exception', 
                sprintf(__('Errore durante il test: %s', 'dynamic-translator'), $e->getMessage())
            );
        }
    }
