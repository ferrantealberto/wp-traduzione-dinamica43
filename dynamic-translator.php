...
class DynamicPageTranslator {
    ...
    private function load_dependencies() {
        ...
        require_once DPT_PLUGIN_PATH . 'includes/class-performance-manager.php';
        require_once DPT_PLUGIN_PATH . 'includes/class-openrouter-models-manager.php';
        require_once DPT_PLUGIN_PATH . 'includes/class-feature-activator.php';
    }
    ...
    private function load_base_modules() {
        $base_modules = array(
            ...
            'woocommerce-translator/woocommerce-translator.php',
            'custom-dictionary/custom-dictionary.php'
        );
    ...
    public function activate() {
        ...
        // Imposta flag per redirect dopo attivazione
        update_option('dpt_features_redirect', true);
